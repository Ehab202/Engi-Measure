...
import 'package:engi_measure/presentation/screens/shaps/rectangle/area/rectangle_area_answer.dart';
...
class RectangleArea extends StatefulWidget {
  static String routeName="Rectangle Area Screen";
...
class _RectangleAreaState extends State<RectangleArea> {
  ...
  void myCalculate(){
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context)=>RectangleAreaAnswer(area: area)));
  }
