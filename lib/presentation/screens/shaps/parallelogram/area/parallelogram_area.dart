...
import 'package:engi_measure/presentation/screens/shaps/parallelogram/area/parallelogram_area_answer.dart';
...
class ParallelogramArea extends StatefulWidget {
  const ParallelogramArea({super.key});
  static String routeName="Parallelogram Area Screen";
 
  @override
  State<ParallelogramArea> createState() => _ParallelogramAreaState();
}

class _ParallelogramAreaState extends State<ParallelogramArea> {
  ...
  void myCalculate(){
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context)=>ParallelogramAreaAnswer(area: area)));
  }
  @override
