...
import 'package:engi_measure/presentation/screens/shaps/rhombus/area&Parameter/rhombus_area_parameter_answer.dart';
...
class RhombusAreaAndParameter extends StatefulWidget {
  const RhombusAreaAndParameter({super.key});
  static String routeName = "Rhombus Area And parameter Screen";

  @override
  State<RhombusAreaAndParameter> createState() =>
      _RhombusAreaAndParameterState();
}

class _RhombusAreaAndParameterState extends State<RhombusAreaAndParameter> {
  ...
  void calculateArea() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => RhombusAreaAndParameterAnswer(
                area: area,
                parameter: parameter,
              )),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: BulidWidgets.bulidTextFormedField(
                  borderColor: Mycolors.rhombusColor,
                  hintText: " Enter the value of Side 2",
                  controller: side2),
            ),
            const SizedBox(
              height: 20,
            ...
            Padding(
              ...
              child: BulidWidgets.bulidTextFormedField(
                  borderColor: Mycolors.rhombusColor,
                  hintText: " Enter the value of side 4",
                  controller: side4),
            ),
            const SizedBox(
              height: 50,
